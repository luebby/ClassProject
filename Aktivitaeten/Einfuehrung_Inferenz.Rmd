...
```
 ...
 Kann der beobachtete Unterschied der Mittelwerte zwischen Montag (`Mon`) und Dienstag (`Tue`) plausibel durch *Zufall* erklärt werden, wenn annehmen, dass es keinen Unterschied in der Verteilung gibt?
